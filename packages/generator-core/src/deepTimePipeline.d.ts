...
export declare function applyDeepTimeFoundation(project: WorldProject, onProgress?: (progress: DeepTimeProgress) => void): DeepTimeProject;
export declare function generateProjectWithDeepTime(input?: Partial<GenerationConfig>, options?: GenerateProjectOptions, onDeepTimeProgress?: (progress: DeepTimeProgress) => void): DeepTimeProject;
//# sourceMappingURL=deepTimePipeline.d.ts.map